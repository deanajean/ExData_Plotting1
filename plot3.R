...
plot(powers$datetime, powers$Sub_metering_1, type = 'l', ylab = "Energy SubMetering", xlab = "")
lines(powers$datetime, powers$Sub_metering_2, type = 'l', col = 'red')
lines(powers$datetime, powers$Sub_metering_3, type = 'l', col = 'blue')
